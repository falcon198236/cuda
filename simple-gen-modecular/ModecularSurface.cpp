...
warranty.
*////////////////////////////////////////////////////////////////
// ModecularSurface.cpp: implementation of the ModecularSurface class.
//
//////////////////////////////////////////////////////////////////////
...
ModecularSurface::ModecularSurface()
{
	int i;
	boxlength=60;
	flagradius=false;
...
void ModecularSurface::calcdepth(int numbb,int seqinit,int seqterm,atom* proseq,boneinfo *bb,bool type)
{
	int i,tind;
	int ox,oy,oz;
	point3d cp;
...
void ModecularSurface::checkEuler()
{
	int i,j,k;
	int ia,ib,ic;
...
void ModecularSurface::laplaciansmooth(int numiter)
{
...
////////////////////////////////////////////////////////////////////////true: heavy atoms
void ModecularSurface::boundbox(int seqinit,int seqterm,atom* proseq,bool atomtype,
...
//label of atom
void ModecularSurface::atomsinout(int seqinit,int seqterm,atom* proseq)
{
	int i;
	for(i=seqinit;i<=seqterm;i++)
	{
...
void ModecularSurface::checkinoutpropa()
{
	int i,j,ia,ib,ic;
	int *vertdeg[40];
	for(i=0;i<40;i++)
...
void ModecularSurface::outputply(char *filename,atom* proseq,int ncolor,int tinout)
...
void ModecularSurface::outputoff(char *filename) 
{
...
void ModecularSurface::buildboundary()
{
	int i,j,k;
	int ii;
	bool flagbound;
...
void ModecularSurface::surfaceinterior()
{
	int i,j,k;
...
void ModecularSurface::outsas(int numbb,boneinfo *bb,atom* proseq,char *filename)
{
...
void ModecularSurface::outputcavityatoms(int seqinit,int seqterm,atom* proseq,char *filename)
{
	FILE  *stream;
    if( (stream =fopen(filename,"w+t"))== NULL)
	{
...
void ModecularSurface::boundingatom(bool btype)
{
	int i,j,k;
	double tradius[13];
...
void ModecularSurface::initpara(int seqinit,int seqterm,atom* proseq,bool atomtype,bool btype)
{
	int i,j;
	double fmargin=2.5;
	if(vp!=NULL)
...
void ModecularSurface::fillatom(int indx,atom* proseq,bool bcolor)
{
	int cx,cy,cz;
	int ox,oy,oz;
	point3d cp;
...
//sas use inout
void ModecularSurface::fillvoxels(int seqinit,int seqterm,bool atomtype,atom* proseq,bool bcolor)
{
...
//use isdone
void ModecularSurface::fillvoxelswaals(int seqinit,int seqterm,bool atomtype,atom* proseq,bool bcolor)
{
	int i,j,k;
	if(vp==NULL)
	{  
...
void ModecularSurface::fillatomwaals(int indx,atom* proseq,bool bcolor)
{
	int cx,cy,cz;
	int ox,oy,oz;
	point3d cp;
...
void ModecularSurface::fastdistancemap(int type)
{
	int i,j,k;
...
void ModecularSurface::fastoneshell(int* innum,int *allocout,voxel2 ***boundpoint, int* outnum, int *elimi)
{
...
//include inner
void ModecularSurface::calcareavolume()
{
	int i,j,k;
...
//cavity number
void ModecularSurface::cavitynumbers()
{
	int i,j,k;
	int l,ii,jj,kk;
...
void ModecularSurface::cavitiesareavolume()
{
	int i,j,k;
	double totarea=0;
	int totvol=0;
...
void ModecularSurface::computenorm()
{
	int i;
	double pnorm;
	for(i=0;i<vertnumber;i++)
...
void ModecularSurface::marchingcubeinit(int stype)
{
	int i,j,k;
	//vdw
	if(stype==1)
...
//half accuracy
void ModecularSurface::marchingcubeorigin(int stype)
{
	int i,j,k;
...
// middle points
void ModecularSurface::marchingcubeorigin2(int stype)
{
	int i,j,k;
	voxel ***vpind;
...
/*
void ModecularSurface::marchingcube(int stype)
{
	int i,j,k;
	marchingcubeinit(stype);
	int ***vertseq;
